...
import cn.psvmc.pulldownlistslideitem.R;

/**
 * 头部动画眼睛
 */
public class ZJPullListHeaderEyeView extends ImageView implements ZJPullListAnimate{
    ...
    public ZJPullListHeaderEyeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mPaint = new Paint();
    ...
    public Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            ...
            ZJPullListHeaderEyeView.this.invalidate();
        }
